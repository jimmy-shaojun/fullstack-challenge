  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="relative flex justify-center place-items-top">
        <TopNUsers type='beneficiary' daysAgo='90' limit='20'></TopNUsers>
        <TopNUsers type='beneficiary' daysAgo='365' limit='20'></TopNUsers>
        <TopNUsers type='beneficiary' daysAgo='1095' limit='20'></TopNUsers>
      </div>
    </main>
  );
}
